    ...
    loadDefaultBehavior() {
        this.hooks.makeRelease.tapPromise("Default", async (options) => {
            if (options.dryRun) {
                ...
                const release = await this.git.publish(options.fullReleaseNotes, options.newVersion, options.isPrerelease, options.to, options.isPrerelease ? false : !this.inOldVersionBranch());
