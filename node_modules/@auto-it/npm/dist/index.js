...
class NPMPlugin {
        ...
        auto.hooks.makeRelease.tapPromise(this.name, async (options) => {
            ...
            if (isIndependent) {
                ...
                const releases = await Promise.all(newTags.map(async (tag) => {
                    ...
                    const isLatestRelease = !options.isPrerelease || !auto.inOldVersionBranch();
                    // 2. make a release for just that package
                    return (_a = auto.git) === null || _a === void 0 ? void 0 : _a.publish(releaseNotes, tag, options.isPrerelease, undefined, isLatestRelease);
                }));
                this.monorepoChangelog = false;
    ...
    async setTokenOnCI(auto) {
        ...
        try {
            ...
            if ((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes(
